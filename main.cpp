...
TEST_CASE("Turing Machine functionality test") {
    ...
    std::vector<std::pair<std::string, std::vector<std::tuple<char, int, char, Command>>>> transitions = {
            {"A", {{'0', 1, '0', Command('R')}, {'1', 3, '1', Command('R')}, {' ', 3, ' ', Command('R')}}},
            {"B", {{'0', 2, '0', Command('R')}, {'1', 1, '1', Command('R')}, {' ', 3, ' ', Command('R')}}},
            {"C", {{'0', 3, '0', Command('R')}, {'1', 3, '1', Command('R')}, {' ', 4, ' ', Command('R')}}}
    };
